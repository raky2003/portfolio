...
const translations = {
  fr: {
    metaDescription: "Portfolio de RAKY DIA, etudiante en Licence 3 MIAGE, developpeuse web et orientee data.",
    navAbout: "A propos",
    navSkills: "Skills",
    ...
    heroRole: "Developpeuse Full Stack & Data",
    ...
    aboutText: "Je suis Raky Dia, etudiante en Licence 3 MIAGE a l'Universite de Rennes 1, avec un profil qui combine developpement web et data. Je developpe des applications web avec Laravel et Symfony, avec une attention particuliere portee a la qualite du code, a l'experience utilisateur et a la structuration des donnees. Je m'interesse egalement a l'analyse de donnees et a la transformation des informations en indicateurs utiles pour aider a la prise de decision.",
    skillsLabel: "Skills",
